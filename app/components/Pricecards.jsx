...
export default function PricingSection() {
    ...
    return (
        <section id="pricing" className="layout-container flex my-16 mx-auto pb-4 px-4 sm:px-8">
            <div className="container grid items-center justify-center gap-12 px-4 md:px-6">
                <div className="space-y-3 text-center">
                    <h1 className="text-3xl font-semibold">Pricing for Every Need</h1>
                    <p className="max-w-lg mx-auto text-lg">
                        Choose the plan that fits your learning style and budget. Get started with our free Basic plan or unlock more features with our Pro and Enterprise options.
                    </p>
                </div>
                ...
                <div className="price-cards-container grid w-full max-w-4xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {pricingPlans.map((plan, index) => (
                        <div key={index} className="flex h-full flex-col justify-between bg-white p-4 rounded-lg shadow-md">
                            <div>
                            ...
                            <button
                                className={`w-full mt-3 py-2 px-4 ${plan.buttonDisabled ? "border border-gray-300 text-black" : "bg-blue-600 text-white"} rounded-lg`}
